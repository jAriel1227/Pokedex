...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryPokedex.Models.Pokemon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryPokedex.Models.Regions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryPokedex.Models.TypePokemon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryPokedex.Models.Pokemon", b =>
                {
                    b.HasOne("LibraryPokedex.Models.Regions", "Regions")
                        .WithMany("pokemons")
                        .HasForeignKey("IDRegions")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryPokedex.Models.TypePokemon", "TypePokemon")
                        .WithMany("typePokemons")
                        .HasForeignKey("IDType1Pokemon")
                        .IsRequired();

                    b.HasOne("LibraryPokedex.Models.TypePokemon", "Type2Pokemon")
